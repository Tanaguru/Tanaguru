 ...
 * @author
 */
public abstract class CommonRuleImplementationTestCase extends AbstractRuleImplementationTestCase {
    ...
    public CommonRuleImplementationTestCase(String testName) {
        super(testName, INPUT_FILE_DATA_NAME, TESTCASE_FILE_PATH);
    }

    public CommonRuleImplementationTestCase(String testName, String inputFileDataName) {
