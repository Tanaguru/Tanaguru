 ...
 * @author jkowalczyk
 */
public class IdElementSelector extends SimpleElementSelector {

    private static final char ID_PREFIX='#';
    
    @Override
    public void setCssLikeQuery(String cssLikeQuery) {
        super.setCssLikeQuery(ID_PREFIX+cssLikeQuery);
    }
     ...
     * @param cssLikeQuery 
     */
    public IdElementSelector(String idValue) {
        setCssLikeQuery(idValue);
    }
