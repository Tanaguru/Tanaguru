 ...
 *
 * @see <a href="http://www.example.com/refential-descriptor.html#test-2-1-1"> 2-1-1 rule specification</a>
 *
 * @author edaconceicao
 */

public class FrameAndIframeHasTitle extends AbstractPageRuleWithSelectorAndCheckerImplementation {

    /**
     * Default constructor
     */
    public FrameAndIframeHasTitle() {
    	super(
