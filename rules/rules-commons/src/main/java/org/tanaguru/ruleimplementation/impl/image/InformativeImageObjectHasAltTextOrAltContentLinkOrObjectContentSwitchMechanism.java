 ...
 *
 * @see <a href="http://www.example.com/refential-descriptor.html#test-1-1-6"> 1-1-6 rule specification</a>
 *
 * @author edaconceicao
 */

public class InformativeImageObjectHasAltTextOrAltContentLinkOrObjectContentSwitchMechanism extends AbstractMarkerPageRuleImplementation {

    /**
     * Default constructor
     */
    public InformativeImageObjectHasAltTextOrAltContentLinkOrObjectContentSwitchMechanism() {
    	super(	//the selector
