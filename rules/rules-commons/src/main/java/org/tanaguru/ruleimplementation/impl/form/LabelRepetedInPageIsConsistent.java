...
import static org.tanaguru.rules.keystore.rgaa4.Rgaa4CssLikeQueryStore.*;

public class LabelRepetedInPageIsConsistent extends AbstractPageRuleWithSelectorAndCheckerImplementation {
    ...
    public LabelRepetedInPageIsConsistent() {
        super();
    }
    ...
    protected void select(SSPHandler sspHandler) {
        ...
        ElementSelector elementSelectorAriaLabelledby = new SimpleElementSelector(INPUT_ELEMENT_WITH_ARIA_LABELLEDBY_RGAA4_CSS_LIKE_QUERY);
        ...
        ElementSelector elementSelectorAriaLabel = new SimpleElementSelector(INPUT_ELEMENT_WITH_ARIA_LABEL_RGAA4_CSS_LIKE_QUERY);
//        elementSelectorAriaLabel.selectElements(sspHandler, ariaLabelDetected);
        ...
        ElementSelector elementSelectorId = new SimpleElementSelector(INPUT_ELEMENT_WITH_ID_RGAA4_CSS_LIKE_QUERY);
        ...
        ElementSelector elementSelectorTitle = new SimpleElementSelector(INPUT_ELEMENT_WITH_TITLE_RGAA4_CSS_LIKE_QUERY);
