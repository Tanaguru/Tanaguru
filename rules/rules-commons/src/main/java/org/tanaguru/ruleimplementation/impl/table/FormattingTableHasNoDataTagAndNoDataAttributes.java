 ...
 *
 * @see <a href="http://www.example.com/refential-descriptor.html#test-5-8-1"> 5-8-1 rule specification</a>
 *
 * @author edaconceicao
 */

public class FormattingTableHasNoDataTagAndNoDataAttributes extends AbstractMarkerPageRuleImplementation {
     ...
     * Default constructor
     */
    public FormattingTableHasNoDataTagAndNoDataAttributes() {
        super(
