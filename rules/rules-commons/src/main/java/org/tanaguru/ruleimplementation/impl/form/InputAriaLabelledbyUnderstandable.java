...
import static org.tanaguru.rules.keystore.rgaa4.Rgaa4CssLikeQueryStore.INPUT_ELEMENT_WITH_ARIA_LABELLEDBY_RGAA4_CSS_LIKE_QUERY;

public class InputAriaLabelledbyUnderstandable extends AbstractPageRuleWithSelectorAndCheckerImplementation {

    /**
     * Default constructor
     */
    public InputAriaLabelledbyUnderstandable() {
         super(
                new SimpleElementSelector(INPUT_ELEMENT_WITH_ARIA_LABELLEDBY_RGAA4_CSS_LIKE_QUERY),
