...
public class InformativeCanvasHasAltTextOrAltContentInCanvasOrAltContentLinkOrCanvasContentSwitchMechanism extends AbstractMarkerPageRuleImplementation {

    /**
     * Default constructor
     */
    public InformativeCanvasHasAltTextOrAltContentInCanvasOrAltContentLinkOrCanvasContentSwitchMechanism() {
    	super(	
