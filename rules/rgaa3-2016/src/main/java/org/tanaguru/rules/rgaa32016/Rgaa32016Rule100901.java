 ...
 */
public class Rgaa32016Rule100901 extends AbstractPageRuleFromPreProcessImplementation {

    static final Logger LOGGER = Logger.getLogger(Rgaa32016Rule100901.class);
