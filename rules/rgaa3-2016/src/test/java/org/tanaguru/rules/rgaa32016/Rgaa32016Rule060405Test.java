...
/**
 * Unit test class for the implementation of the rule 6-4-5 of the referential Rgaa 3-2016.
 *
 * @author
 */
public class Rgaa32016Rule060405Test extends Rgaa32016RuleImplementationTestCase {

    /**
     * Default constructor
     * @param testName
     */
    public Rgaa32016Rule060405Test (String testName){
        super(testName);
    }
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName(
                "org.tanaguru.rules.rgaa32016.Rgaa32016Rule060405");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa32016.Test.6.4.5-1Passed-01");
        addWebResource("Rgaa32016.Test.6.4.5-2Failed-01");
        addWebResource("Rgaa32016.Test.6.4.5-2Failed-02");
        addWebResource("Rgaa32016.Test.6.4.5-2Failed-03");
        addWebResource("Rgaa32016.Test.6.4.5-2Failed-04");
        addWebResource("Rgaa32016.Test.6.4.5-3NMI-01");
        addWebResource("Rgaa32016.Test.6.4.5-3NMI-02");
        addWebResource("Rgaa32016.Test.6.4.5-4NA-01");
        addWebResource("Rgaa32016.Test.6.4.5-4NA-02");
        addWebResource("Rgaa32016.Test.6.4.5-4NA-03");
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
        checkResultIsPassed(processPageTest("Rgaa32016.Test.6.4.5-1Passed-01"), 2);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa32016.Test.6.4.5-2Failed-01");
        ...
        //------------------------------2Failed-02------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32016.Test.6.4.5-2Failed-02");
        checkResultIsFailed(processResult, 2, 2);
        checkRemarkIsPresent(
                processResult,
                TestSolution.FAILED,
        ...
        //------------------------------2Failed-03------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32016.Test.6.4.5-2Failed-03");
        ...
        //------------------------------2Failed-04------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32016.Test.6.4.5-2Failed-04");
        checkResultIsFailed(processResult, 4, 4);
        checkRemarkIsPresent(
                processResult,
                TestSolution.FAILED,
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32016.Test.6.4.5-3NMI-01");
        ...
        //------------------------------3NMI-02---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32016.Test.6.4.5-3NMI-02");
        checkResultIsPreQualified(processResult, 2, 2);
        checkRemarkIsPresent(
                processResult,
                TestSolution.NEED_MORE_INFO,
        ...
        //------------------------------4NA-01----------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.6.4.5-4NA-01"));

        //----------------------------------------------------------------------
        //------------------------------4NA-02----------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.6.4.5-4NA-02"), 1);

        //----------------------------------------------------------------------
        //------------------------------4NA-03----------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.6.4.5-4NA-03"));
        
        
        // 06.04.01 testcases : All is Not Applicable
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-1Passed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-1Passed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-2Failed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-2Failed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-2Failed-03"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-3NMI-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-3NMI-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.01-3NMI-03"));
        
        // 06.04.02 testcases : All is Not Applicable
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-1Passed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-1Passed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-1Passed-03"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-1Passed-04"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-03"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-04"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-05"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-06"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-07"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-2Failed-08"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-3NMI-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-3NMI-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.02-3NMI-03"));

        // 06.04.03 testcases : All is Not Applicable
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-1Passed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-1Passed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-2Failed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-2Failed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-2Failed-03"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-3NMI-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-3NMI-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.03-3NMI-03"));
        
        // 06.04.04 testcases : All is Not Applicable
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-1Passed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-1Passed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-1Passed-03"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-1Passed-04"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-03"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-04"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-05"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-06"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-07"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-2Failed-08"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-3NMI-01"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-3NMI-02"));
        checkResultIsNotApplicable(processPageTest("Rgaa32016.Test.06.04.04-3NMI-03"));
    }

    @Override
    protected void setConsolidate() {
        assertEquals(TestSolution.PASSED,
                consolidate("Rgaa32016.Test.6.4.5-1Passed-01").getValue());
        assertEquals(TestSolution.FAILED,
                consolidate("Rgaa32016.Test.6.4.5-2Failed-01").getValue());
        assertEquals(TestSolution.FAILED,
                consolidate("Rgaa32016.Test.6.4.5-2Failed-02").getValue());
        assertEquals(TestSolution.FAILED,
                consolidate("Rgaa32016.Test.6.4.5-2Failed-03").getValue());
        assertEquals(TestSolution.FAILED,
                consolidate("Rgaa32016.Test.6.4.5-2Failed-04").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.6.4.5-4NA-01").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.6.4.5-4NA-02").getValue());
        assertEquals(TestSolution.NOT_APPLICABLE,
                consolidate("Rgaa32016.Test.6.4.5-4NA-03").getValue());
