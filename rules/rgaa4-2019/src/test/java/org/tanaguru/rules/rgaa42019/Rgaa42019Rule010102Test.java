...
//        addWebResource("Rgaa4-2019.Test.1.1.2-1Passed-01");
//        addWebResource("Rgaa4-2019.Test.1.1.2-2Failed-01");
        addWebResource("Rgaa4-2019.Test.1.1.2-3NMI-01");
//        addWebResource("Rgaa4-2019.Test.1.1.2-4NA-01");
    }
    ...
    protected void setProcess() {
        ...
        //------------------------------1Passed-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsPassed(processPageTest("Rgaa4-2019.Test.1.1.2-1Passed-01"), 1);

        //----------------------------------------------------------------------
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
//        ProcessResult processResult = processPageTest("Rgaa4-2019.Test.1.1.2-2Failed-01");
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa4-2019.Test.1.1.2-3NMI-01");
...
//                new ImmutablePair("#ExtractedAttributeAsEvidence", "#ExtractedAttributeValue"));
        ...
        //------------------------------4NA-01------------------------------
        //----------------------------------------------------------------------
//        checkResultIsNotApplicable(processPageTest("Rgaa4-2019.Test.1.1.2-4NA-01"));
    }
    ...
    protected void setConsolidate() {
        ...
        assertEquals(TestSolution.NOT_TESTED,
                consolidate("Rgaa4-2019.Test.1.1.2-3NMI-01").getValue());
}
