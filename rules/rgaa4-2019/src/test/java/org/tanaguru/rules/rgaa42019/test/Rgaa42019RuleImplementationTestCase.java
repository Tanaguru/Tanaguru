 ...
 */
package org.tanaguru.rules.rgaa42019.test;
 ...
 * @author
 */
public abstract class Rgaa42019RuleImplementationTestCase extends AbstractRuleImplementationTestCase {
    ...
    public Rgaa42019RuleImplementationTestCase(String testName) {
        super(testName, INPUT_FILE_DATA_NAME, TESTCASE_FILE_PATH);
    }
    
    public Rgaa42019RuleImplementationTestCase(String testName, String inputFileDataName) {
