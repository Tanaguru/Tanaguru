...
public class Rgaa32017Rule090104Test extends Rgaa32017RuleImplementationTestCase {
    ...
    protected void setUpRuleImplementationClassName() {
        setRuleImplementationClassName("org.tanaguru.rules.rgaa32017.Rgaa32017Rule090104");
    }

    @Override
    protected void setUpWebResourceMap() {
        addWebResource("Rgaa32017.Test.09.01.04-2Failed-01");
        addWebResource("Rgaa32017.Test.09.01.04-2Failed-02");
        addWebResource("Rgaa32017.Test.09.01.04-3NMI-01");
        addWebResource("Rgaa32017.Test.09.01.04-3NMI-02");
        addWebResource("Rgaa32017.Test.09.01.04-4NA-01");
    }
    ...
    protected void setProcess() {
        ...
        //------------------------------2Failed-01------------------------------
        //----------------------------------------------------------------------
        ProcessResult processResult = processPageTest("Rgaa32017.Test.09.01.04-2Failed-01");
        ...
        checkRemarkIsPresent(
                ...
                1, 
                new ImmutablePair(HtmlElementStore.TEXT_ELEMENT2,"Rgaa32017 Test.9.1.4 Failed 01"),
        ...
        //------------------------------2Failed-02------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.09.01.04-2Failed-02");
        ...
        checkRemarkIsPresent(
                ...
                HtmlElementStore.H1_ELEMENT, 
                1, 
                new ImmutablePair(HtmlElementStore.TEXT_ELEMENT2,"Rgaa32017 Test.9.1.4 Failed 02"),
                new ImmutablePair(ProcessRemarkService.DEFAULT_EVIDENCE,"headings"));
        checkRemarkIsPresent(
                processResult, 
                TestSolution.FAILED, 
        ...
        //------------------------------3NMI-01---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.09.01.04-3NMI-01");
        ...
        checkRemarkIsPresent(
                ...
                HtmlElementStore.H1_ELEMENT, 
                1, 
                new ImmutablePair(HtmlElementStore.TEXT_ELEMENT2,"Rgaa32017 Test.9.1.4 NMI 01"),
                new ImmutablePair(ProcessRemarkService.DEFAULT_EVIDENCE,"headings"));
        checkRemarkIsPresent(
                processResult, 
                TestSolution.NEED_MORE_INFO, 
        ...
        //------------------------------3NMI-02---------------------------------
        //----------------------------------------------------------------------
        processResult = processPageTest("Rgaa32017.Test.09.01.04-3NMI-02");
        ...
        checkRemarkIsPresent(
                ...
                HtmlElementStore.H1_ELEMENT, 
                1, 
                new ImmutablePair(HtmlElementStore.TEXT_ELEMENT2,"Rgaa32017 Test.9.1.4 NMI 02"),
                new ImmutablePair(ProcessRemarkService.DEFAULT_EVIDENCE,"headings"));
        checkRemarkIsPresent(
                processResult, 
                TestSolution.NEED_MORE_INFO, 
        ...
        //------------------------------4NA-01----------------------------------
        //----------------------------------------------------------------------
        checkResultIsNotApplicable(processPageTest("Rgaa32017.Test.09.01.04-4NA-01"));
    }
