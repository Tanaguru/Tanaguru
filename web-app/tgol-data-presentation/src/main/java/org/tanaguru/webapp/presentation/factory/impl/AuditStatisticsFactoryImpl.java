 ...
 * @author jkowalczyk
 */
public class AuditStatisticsFactoryImpl implements AuditStatisticsFactory {
    ...
    public AuditStatistics getAuditStatistics(
        ...
        if(webResource.getSnapshot() != null){
            String b64Snapshot = Base64.getEncoder().encodeToString(webResource.getSnapshot());
            auditStats.setSnapshot(b64Snapshot);
        }
    ...
    private ResultCounter getResultCounterByThemeForTest(
        ...
        ResultCounter resultCounter
                = ResultCounterFactoryImpl.getInstance().getResultCounter();
