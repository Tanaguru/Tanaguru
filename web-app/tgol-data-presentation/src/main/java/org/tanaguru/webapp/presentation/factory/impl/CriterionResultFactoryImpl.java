 ...
 * @author jkowalczyk
 */
public final class CriterionResultFactoryImpl implements CriterionResultFactory {
    ...
    /**
     * The unique shared instance of CriterionResultFactoryImpl
     */
    ...
    public CriterionResult getCriterionResult(
        ...
        criterionResult.setId(criterionStatistics.getId());
