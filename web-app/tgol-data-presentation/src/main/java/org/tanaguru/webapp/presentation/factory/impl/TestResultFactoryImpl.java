 ...
 * @author jkowalczyk
 */
public final class TestResultFactoryImpl implements TestResultFactory {
    ...
    /**
     * The unique shared instance of TestResultFactoryImpl
     */
    ...
    public TestResult getTestResult(
        ...
        testResult.setResultCounter(ResultCounterFactoryImpl.getInstance().getResultCounter());
    ...
    public Map<Theme, List<TestResult>> getTestResultSortedByThemeMap(
        ...
        if (testSolutionList.isEmpty() || testSolutionList.contains(NOT_TESTED_STR)) {
    ...
    private RemarkInfos getRemarkInfo(
        ...
        if (remarkTarget != null) {
            newRemarkInfo = RemarkInfosFactoryImpl.getInstance().getRemarksInfo(messageCode, remarkTarget);
        } else {
            newRemarkInfo = RemarkInfosFactoryImpl.getInstance().getRemarksInfo(messageCode);
        }
