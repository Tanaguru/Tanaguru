 ...
 * @author jkowalczyk
 */
public final class DetailedContractInfoFactoryImpl extends ContractInfoFactoryImpl implements DetailedContractInfoFactory {
    ...
    /**
     * The unique shared instance of DetailedContractInfoFactoryImpl
     */
     ...
     */
    private DetailedContractInfoFactoryImpl() {}

    public static synchronized DetailedContractInfoFactory getInstance() {
        if (detailedContractInfoFactory == null) {
            detailedContractInfoFactory = new DetailedContractInfoFactoryImpl();
        }
    ...
    protected DetailedContractInfo setNLastActInfo(Contract contract, DetailedContractInfo detailedContractInfo) {
        ...
        for (Act act : lastActSet) {
            detailedContractInfo.addActInfo(ActInfoFactoryImpl.getInstance().getActInfo(act));
        }
        detailedContractInfo.setNumberOfDisplayedAct(lastActSet.size());
        detailedContractInfo.setSiteActInfoSet(ActInfoFactoryImpl.getInstance().getActInfoSet(
